...
3. Stratified calculation and plotting is possible
...
x <- c("year", "age", "log_sqft_living", "log_sqft_lot", "bedrooms",
       "bathrooms", "log_sqft_basement", "condition", "waterfront", "zipcode")
...
First, let's evaluate model RMSE and R-squared on the hold-out dataset. Here, the mixed-effects model performs a tiny little bit better than the random forest:
